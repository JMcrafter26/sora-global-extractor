...
async function extractStreamUrl(url) {
  try {
    ...
    // Available providers: bigwarp, doodstream, earnvids, filemoon, lulustream, megacloud, mp4upload, sendvid, sibnet, streamtape, streamup, supervideo, uploadcx, uqload, videospk, vidmoly, vidoza, voe
